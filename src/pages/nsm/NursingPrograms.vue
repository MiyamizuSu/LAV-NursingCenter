    ...
    <el-col style=" align-items: center; ">
      <el-card shadow="hover" class="section-card">
        <p>
          ...
          <Button @click="showPriceChart"
            style="margin-left: 2vh; margin-bottom: 2vh; margin-left: 2vh; font-size: 15px; background-color: #67C23A;">价格统计</Button>
        </p>
        ...
        <el-table class="rounded-b-md shadow-md" :data="allPrograms" :border="true" :stripe="true" style="width: 100%;"
          ...
          <el-table-column label="操作" align="center" min-width="100">
            <template #default="scope">
              ...
              <el-button @click="deleteProgram(scope.row)" style="color: red; margin-left: 3vh;">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        ...
        <el-dialog v-model="dialogFormControl.isVisible" :title="dialogFormControl.title"
          ...
          <el-form :model="editForm" :rules="editProgramRules">
            <el-form-item label="名称" prop="name" label-width="100px">
              ...
              <el-input clearable v-model="editForm.name" placeholder="输入项目名称后点击右侧魔棒图标生成" @keyup.enter="generateByAI"
                style="width: 350px;">
                <template #append v-if="!dialogFormControl.isUpdate">
                  <el-button  :icon="MagicStick" @click="generateByAI"
                    :loading="isAILoading" title="AI智能生成" />
                </template>
              </el-input>
            </el-form-item>
            ...
            <el-form-item label="执行周期" prop="executionPeriod" label-width="100px">
              <el-select v-model="editForm.executionPeriod" placeholder="请选择护理项目执行周期" size="large" style="width: 350px">
            ...
            <el-form-item label="状态" prop="status" label-width="100px">
              <el-select v-model="editForm.status" placeholder="请选择护理项目状态" size="large" style="width: 350px">
        ...
        <!-- 价格统计对话框 -->
        <el-dialog v-model="chartDialogVisible" title="护理项目价格统计" width="800" draggable overflow
        ...
        <el-pagination :current-page="queryEntity.current" :page-sizes="[1, 5, 10, 50]"
          ...
          @update:current-page="handleCurrentChange" layout="total, sizes, prev, pager, next, jumper" :total="total"
