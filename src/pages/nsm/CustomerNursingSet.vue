...
<template>
    <el-main style="align-content: center;">
        ...
        style="margin-top: 3vh; margin-left: 25%; align-items: center;">
            <p>
                <!-- 搜索框 -->
                <el-input v-model="queryEntity.name" clearable placeholder="客户姓名" style="width: 30vh;"></el-input>
...
import { type NursingLevel, type NursingProgram, type Customer, type CustomerNursingService } from '@/lib/entity';
