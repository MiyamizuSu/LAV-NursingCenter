...
<template>
    <el-container style="padding: 0; overflow-y: auto;">
        <el-col style="width: 100%;">
            <el-card shadow="hover" class="section-card" style="width: 100%;">
                ...
                <div class="text-white px-4 py-2 font-semibold rounded-t-md" style="background-color: #007bff;">
                    {{currentCustomer.name }} - 已购的护理项目
                </div>
                <el-table class="shadow-md rounded-b-md" :data="currentServices" :stripe="true" style="width: 100%;" :fit="true"
        ...
        <el-dialog v-model="add_dialogControl.isVisible" :title="add_dialogControl.title"
            style="width: 1250px; height: 750px; overflow-y: auto;" draggable overflow>
            ...
            <el-table :data="selectedServices" :stripe="true" style="width: 100%;"
                ...
                <el-table-column label="购买数量" align="center" min-width="80">
                    <template #default="scope">
                        <el-input-number v-model="scope.row.totalCount" :min="1" controls-position="right"
                            style="width: 80px;" />
                    </template>
                </el-table-column>
                <el-table-column label="服务到期日期" align="center" min-width="100">
                    <template #default="scope">
