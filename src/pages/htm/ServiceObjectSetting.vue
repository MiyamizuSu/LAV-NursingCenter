...
<template>
    <el-container style="align-content: center; overflow-y: auto;">
        ...
        <el-col style="margin-left: 5%; width: 95%;">
            ...
            <el-pagination
                :current-page="nurse_queryEntity.current"
                :page-sizes="[1, 5, 10, 50]"
                :default-page-size="nurse_queryEntity.size"
                @update:page-size="nurse_handleSizeChange"
                @update:current-page="nurse_handleCurrentChange"
